...
<ActionCardGrid>
  <ActionCard href="https://spelunker.cave-explorer.org/#!middleauth+https://global.daf-apis.com/nglstate/api/v1/5192626524389376" title="Visualize predictions in MICrONS" subtitle="Neuroglancer link with segment properties" caption="Requires Google login, agreement to Terms of Service" ancillaryHref="https://global.daf-apis.com/sticky_auth/api/v1/tos/2/accept" ancillaryText="Accept MICrONS Terms of Service (only required once)" />
  <ActionCard href="https://tutorial.microns-explorer.org/python-tools.html" title="Query predictions programmatically" subtitle="MICrONS tutorials" caption="Table name: <code>synapse_target_predictions_ssa_v2</code>" />
