...
<ActionCardGrid>
  ...
  <ActionCard href="./programmatic-access" title="Query predictions programmatically" subtitle="CAVEclient example" caption="Table name: <code>synapse_target_predictions_ssa_v2</code>" />
