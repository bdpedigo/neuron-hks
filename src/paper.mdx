...
links:
  ...
  - name: Cloud deployment
    url: https://github.com/bdpedigo/ssa-cloud
    icon: ri:github-line
...
```bibtex
@article{pedigo2026census,
  author  = {Pedigo, Benjamin D. and Danskin, Bethanny P. and Swanstrom, Rachael and Neace, Erika and Dorkenwald, Sven and {Ma\c{c}arico da Costa}, Nuno and Schneider-Mizell, Casey M. and Collman, Forrest},
  title   = {A quantitative census of millions of postsynaptic structures in a large electron microscopy volume of mouse visual cortex},
  journal = {bioRxiv},
  year    = {2026},
