...
<ActionCardGrid>
  ...
  <ActionCard href="https://www.microns-explorer.org/" title="Visualize predictions in MICrONS" subtitle="MICrONS Explorer" />
  <ActionCard href="https://tutorial.microns-explorer.org/python-tools.html" title="Query predictions programmatically" subtitle='MICrONS tutorials · <code class="font-mono text-xs text-zinc-600 dark:text-zinc-300">synapse_target_predictions_ssa_v2</code>' />
